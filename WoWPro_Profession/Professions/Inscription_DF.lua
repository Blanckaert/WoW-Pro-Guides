...
local guide = WoWPro:RegisterGuide("BlancScribe_DF", "Profession", "Inscription_DF", "WoWPro Team", "Neutral")
WoWPro:GuideIcon(guide,"PRO",773)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Inscription_Dragonflight")
WoWPro:GuideNickname(guide, "Scribe_DF")
...
N This Guide|QID|773000001|N|Covers DRAGONFLIGHT content in Retail.  This is just a starter guide, DOES NOT include anything for getting better Qualities OR any Specializations.|
