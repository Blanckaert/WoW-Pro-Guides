...
local guide = WoWPro:RegisterGuide("BlancLTW_HUB","Profession","Leatherworking_HUB", "WoWPro Team", "Neutral")
WoWPro:GuideIcon(guide,"PRO",165)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Leatherworking: Guide Hub")
WoWPro:GuideNickname(guide, "LTW_GH")
...
N Cataclysm Plans|QID|165301075|JUMP|LTW_Cata|S|N|Jump to Cataclysm Plans 1 - 75 guide.|NOCACHE|
N Pandaren Plans|QID|165401075|JUMP|LTW_MoP|S|N|Jump to Pandaren Plans 1 - 75 guide.|NOCACHE|
N Draenor Plans|QID|165501100|JUMP|LTW_WoD|S|N|Jump to Draenor Plans 1 - 100 guide.|NOCACHE|
