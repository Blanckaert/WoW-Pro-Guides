...
local guide = WoWPro:RegisterGuide("BlancTLR_DF", "Profession", "Tailoring_DF", "WoWPro Team", "Neutral")
WoWPro:GuideIcon(guide,"PRO",197)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Tailoring_Dragonflight")
WoWPro:GuideNickname(guide, "TLR_DF")
...
N Things To Note|QID|197000001|N|Covers DRAGONFLIGHT content in Retail.  This is just a starter guide, DOES NOT include anything for getting better Qualities OR any Specializations.|
