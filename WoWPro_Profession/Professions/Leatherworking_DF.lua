...
local guide = WoWPro:RegisterGuide("BlancLeather_DF", "Profession", "Leatherworking_DF", "WoWPro Team", "Neutral")
WoWPro:GuideIcon(guide,"PRO",165)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Leatherworking_Dragonflight")
WoWPro:GuideNickname(guide, "LTW_DF")
...
N This Guide|QID|165000001|N|Covers DRAGONFLIGHT content in Retail.  This is just a starter guide, DOES NOT include anything for getting better Qualities OR any Specializations.|
