...
local guide = WoWPro:RegisterGuide("BlancJC_DF", "Profession" ,"Jewelcrafting_DF", "WoWPro Team", "Neutral")
WoWPro:GuideIcon(guide,"PRO",755)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Jewelcrafting_Dragonflight")
WoWPro:GuideNickname(guide, "JC_DF")
...
N This Guide|QID|755000001|N|Covers DRAGONFLIGHT content in Retail.  This is just a starter guide, DOES NOT include anything for getting better Qualities OR any Specializations.|
