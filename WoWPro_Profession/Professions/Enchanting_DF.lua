...
local guide = WoWPro:RegisterGuide("BlancENCH_DF","Profession","Enchanting_DF", "WoWPro Team", "Neutral")
WoWPro:GuideIcon(guide,"PRO",333)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Enchanting_Dragonflight")
WoWPro:GuideNickname(guide, "ENCH_DF")
...
N This Guide|QID|333000001|N|Covers DRAGONFLIGHT content in Retail.  This is just a starter guide, DOES NOT include anything for getting better Qualities OR any Specializations. |
