...
local guide = WoWPro:RegisterGuide("BlancBSM_DF","Profession","Blacksmithing_DF", "WoWPro Team", "Neutral")
WoWPro:GuideIcon(guide,"PRO",164)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Blacksmithing_Dragonflight")
WoWPro:GuideNickname(guide, "BSM_DF")
...
N This Guide|QID|164000001|N|Covers DRAGONFLIGHT content in Retail.  This is just a starter guide, DOES NOT include anything for getting better Qualities OR any Specializations. |
