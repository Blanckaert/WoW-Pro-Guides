...
local guide = WoWPro:RegisterGuide("BlancENG_DF", "Profession", "Engineering_DF", "WoWPro Team", "Neutral")
WoWPro:GuideIcon(guide,"PRO",202)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Engineering_Dragonflight")
WoWPro:GuideNickname(guide, "ENG_DF")
...
N Things To Note|QID|202000001|N|Covers DRAGONFLIGHT content in Retail.  This is just a starter guide, DOES NOT include anything for getting better Qualities OR any Specializations.|
